...
const CATALOGOS: CatalogoSemilla[] = [
  ...
  {
    codigo: 'manejo_residuos',
    nombre: 'Manejo de residuos sólidos',
    jerarquico: false,
    items: [
      { codigo: 'recoleccion_publica', nombre: 'Recolección pública' },
      { codigo: 'quema', nombre: 'Quema' },
      { codigo: 'entierro', nombre: 'Entierro' },
      { codigo: 'botadero_abierto', nombre: 'Botadero a cielo abierto' },
      { codigo: 'reciclaje', nombre: 'Reciclaje / reutilización' },
      { codigo: 'otro', nombre: 'Otro' },
    ],
  },
  {
    codigo: 'tipo_conectividad',
    nombre: 'Tipo de conectividad',
    jerarquico: false,
    items: [
      { codigo: 'ninguna', nombre: 'Ninguna' },
      { codigo: 'telefonia_movil', nombre: 'Telefonía móvil' },
      { codigo: 'internet_fijo', nombre: 'Internet fijo' },
      { codigo: 'internet_movil', nombre: 'Internet móvil' },
      { codigo: 'telefonia_e_internet', nombre: 'Telefonía e internet' },
      { codigo: 'otro', nombre: 'Otro' },
    ],
  },
  {
